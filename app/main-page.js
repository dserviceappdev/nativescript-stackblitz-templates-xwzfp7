// >> setting-url-webview
import { Dialogs, Observable, WebView, Page } from '@nativescript/core';

export function onNavigatingTo(args) {
  const page = args.object;
  const vm = new Observable();
  vm.set('webViewSrc', 'https://6libera.d-serviceitalia.it');
  vm.set('result', '');
  vm.set('tftext', 'https://6libera.d-serviceitalia.it/');
